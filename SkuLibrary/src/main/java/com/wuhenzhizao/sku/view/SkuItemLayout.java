...
public class SkuItemLayout extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        attributeNameParams.topMargin = ScreenUtils.dp2PxInt(context, 5);
...
//        lineParams.leftMargin = ScreenUtils.dp2PxInt(context, 10);
//        lineParams.rightMargin = ScreenUtils.dp2PxInt(context, 10);
