...
public class AfterSalesActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initView() {
        ...
        promptDialog.setMessage(String.format("是否拨打%s", MyApp.app.customerServicePhone),"取消","拨打");
        promptDialog.setOkClickListener(new PromptDialog.OnOkClickListener() {
            @Override
            public void onClick() {
                AppUtils.callPhone(mContext, MyApp.app.customerServicePhone);
            }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.after_sales_tui://退货，退款
                MyApp.app.activityTool.toReturnSelectActivity(mContext,getIntent());
                break;
