...
import com.juntai.shop.mall.ui.act.SettingActivity;
import com.juntai.shop.mall.ui.my.ui.MyAssessActivity;
import com.juntai.shop.mall.ui.my.ui.MyCollectActivity;
import com.juntai.shop.mall.ui.my.ui.MyOrderActivity;
...
public class MyFragment extends BaseLazyFragment implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        if (App.app.getUser() == null){
            ...
            tvNick.setText(App.app.getUser().getReturnValue().getNickName());
        }
                ...
                .subscribe(new Consumer<UserB>() {
                    ...
                    public void accept(UserB result) throws Exception {
                        if (result.success && result.getReturnValue() != null){
                            ...
                            userB = result;
                            App.app.customerServicePhone = userB.getReturnValue().getCustomerServicePhone();
                            ...
                            if (result.getReturnValue().getWeChatId() == null || result.getReturnValue().getWeChatId().equals("")){
                                tvWx.setText("未绑定");
                                tvWx.setOnClickListener(MyFragment.this);
                            }else {
                                tvWx.setText(result.getReturnValue().getWeChatName());
                            ...
                            if (result.getReturnValue().getQqId() == null || result.getReturnValue().getQqId().equals("")){
                                tvQQ.setText("未绑定");
                                tvQQ.setOnClickListener(MyFragment.this);
                            }else {
                                tvQQ.setText(result.getReturnValue().getQqName());
    ...
    public void loginout(){
        AppNetModule.createrRetrofit()
                .loginOut(App.app.getAccount(),App.app.getUserToken())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
