...
package com.juntai.mall.bdmap.utils.clusterutil.clustering.algo;
...
import com.juntai.mall.bdmap.utils.clusterutil.projection.Bounds;
...
import com.juntai.mall.bdmap.utils.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.juntai.mall.bdmap.utils.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.juntai.mall.bdmap.utils.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.juntai.mall.bdmap.utils.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.juntai.mall.bdmap.utils.clusterutil.clustering.algo
