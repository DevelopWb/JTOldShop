...
import com.juntai.mall.bdmap.utils.NagivationUtils;
 ...
 * on 2019/4/17
 */
public class NavigationSetValueDialog extends DialogFragment implements View.OnClickListener {
    //
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.dialog_nagivation,null);
...
//        navigationTx.setVisibility(txExist?View.VISIBLE:View.GONE);
        ...
        if (i == R.id.nagivation_bd) {
            ...
            if (bdExist){
                ...
                String url = "http://api.map.baidu.com/direction?origin=latlng:"
                        ...
                        + bdLocation.getCity()+"&output=html&src=webapp.baidu.openAPIdemo";
                toExplorer(url);
            }
            ...
            if (gdExist){
                ...
                LatLng latLng = NagivationUtils.BD2GCJ(new LatLng(bdLocation.getLatitude(),bdLocation.getLongitude()));
     ...
     * @param address
     */
    public void showMenu(FragmentManager fragmentManager,Double lat, Double lng, String address,BDLocation location){
        this.lat = lat;
        this.lng = lng;
     ...
     * @param address
     */
    public void showMenu(FragmentTransaction fragmentTransaction, Double lat, Double lng, String address,BDLocation location){
        this.lat = lat;
        this.lng = lng;
        this.address = address;
        bdLocation = location;
